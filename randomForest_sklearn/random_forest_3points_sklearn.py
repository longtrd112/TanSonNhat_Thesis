...
features_with_outliers = ['first_altitude', 'first_ground_speed', 'second_altitude', 'second_ground_speed',
...
hyper_parameters = {
    ...
    'max_depth': [3, 4, 5, 7, 9, 10, 11, 12],
    'max_features': [4, 5, 6, 7, 8, 10, 12, 14],
    'min_samples_leaf': [3, 4, 5, 6, 7, 8, 10, 12, 14]
}
