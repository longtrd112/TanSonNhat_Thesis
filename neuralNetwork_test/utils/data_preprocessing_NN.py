...
class Data1:
    def __init__(self, dataFile):
        try:
            ...
            self.X_flight_train = self.X_train.drop(['wind_speed', 'visibility', 'skyc1'], axis=1)
            self.X_flight_val = self.X_val.drop(['wind_speed', 'visibility', 'skyc1'], axis=1)
            self.X_flight_test = self.X_test.drop(['wind_speed', 'visibility', 'skyc1'], axis=1)
            self.X_weather_train = self.X_train[['wind_speed', 'visibility', 'skyc1']]
            self.X_weather_val = self.X_val[['wind_speed', 'visibility', 'skyc1']]
            self.X_weather_test = self.X_test[['wind_speed', 'visibility', 'skyc1']]
